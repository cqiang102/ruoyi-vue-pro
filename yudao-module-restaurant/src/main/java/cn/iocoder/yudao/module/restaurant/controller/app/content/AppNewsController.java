package cn.iocoder.yudao.module.restaurant.controller.app.content;
...
public class AppNewsController {
    ...
    @GetMapping("/list")
    @Operation(summary = "资讯列表（本店 + 全平台，已发布）")
    @Parameter(name = "storeId", description = "门店编号", required = true)
    public CommonResult<List<NewsVO>> getNewsList(@RequestParam("storeId") Long storeId) {
        // 需登录：租户上下文
        SecurityFrameworkUtils.getLoginUserId();
        return success(newsService.getNewsListForMember(storeId));
    }
